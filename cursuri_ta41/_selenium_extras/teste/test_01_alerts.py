...
comanda pentru rulat secvential: pytest _selenium_extras/teste/test_01_alerts.py
comanda pentru rulat in paralel : pytest _selenium_extras/teste/test_01_alerts.py -n 2
"""
