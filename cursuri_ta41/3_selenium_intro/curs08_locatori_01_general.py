...
link_web_form_nou = driver.find_element(By.LINK_TEXT, 'Complete Web Form')
link_web_form_nou.click()
time.sleep(1)
# punem un break point la linia anterioara << link_web_form_nou.click() >> si compilam codul cu debugger
