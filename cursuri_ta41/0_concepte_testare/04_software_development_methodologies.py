...
Waterfall = O metodologie de software development care presupune desfasurarea activitatilor in cascada (adica rezultatul
            unei etape reprezinta date de intrare pentru urmatoarea etapa)
        ...
        Dezavantaje:
            - daca vrem sa modificam ceva in mijlocul procesului de dezvoltare / testare (adica ne-am razgandit si vrem
                altceva, sau vrem ceva aditional) atunci trebuie sa se creeze un proiect nou care sa urmeze toate
                etapele anterioare, cu buget si timeline separat
...
Agile = O metodologie de software development care presupune dezvoltarea produsului pe bucati intr-o serie de
        ...
        Avantaje:
            ...
            - primim feedback timpuriu legat de functionalitatea produsului si avem o siguranta mai mare asupra
                calitatii finale a produsului din punctul de vedere al nevoilor clientului

Elemente ale metodologiei Agile:

- Backlog = Totalitatea elementelor care se doresc a fi implementate in cadrul unui proiect

- Backlog refinement = Filtrarea functionalitatilor care nu sunt urgente sau care sunt mai greu de implementat pentru
    beneficiul pe care il aduc si respectiv clatificarea si detalierea functionalitatilor ramase de implementat
...
- Sprint retrospective = Analiza desfasurarii sprint-ului din punctul de vedere al lucrurilor care au fost ok si trebuie
